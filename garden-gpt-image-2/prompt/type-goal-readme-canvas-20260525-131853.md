{
  ...
  "nodes": {
    "items": [
      ...
      { "id": "N11", "label": "反模式检测", "role": "Gate Control", "region": "R2" },
  ...
  "edges": {
    "items": [
      ...
      { "from": "N7", "to": "N8" },
      { "from": "N8", "to": "N9" },
      { "from": "N10", "to": "N1", "label": "门控" },
      { "from": "N10", "to": "N3", "label": "门控" },
      { "from": "N12", "to": "N2", "label": "评审" },
      { "from": "N14", "to": "N7", "label": "审查" },
      { "from": "N16", "to": "N3", "label": "数据" },
      { "from": "N19", "to": "N7", "label": "构建" },
      { "from": "N9", "to": "N20", "label": "生成" }
    ],
    "edge_style": {
